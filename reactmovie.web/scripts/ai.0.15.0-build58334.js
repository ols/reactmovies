        ...
        var Util = (function () {
            ...
            Util.dump = function (object) {
                ...
                if (objectTypeDump === "[object Error]") {
                    propertyValueDump = "{ stack: '" + object.stack + "', message: '" + object.message + "', title: '" + object.name + "'";
                }
...
(function (AI) {
    ...
    var ContextTagKeys = (function () {
        function ContextTagKeys() {
            ...
            this.operationName = "ai.operation.title";
                    ...
                    DataSanitizer.sanitizeKey = function (name) {
                        if (name) {
                            ...
                            if (name.search(/[^0-9a-zA-Z-._()\/ ]/g) >= 0) {
                                ...
                                ApplicationInsights._InternalLogging.throwInternalUserActionable(1 /* WARNING */, "title contains illegal characters. Illgeal character have been replaced with '_'. new title: " + name);
                            }
                            if (name.length > DataSanitizer.MAX_NAME_LENGTH) {
                                name = name.substring(0, DataSanitizer.MAX_NAME_LENGTH);
                                ApplicationInsights._InternalLogging.throwInternalUserActionable(1 /* WARNING */, "title is too long.  It has been truncated to " + DataSanitizer.MAX_NAME_LENGTH + " characters.  title: " + name);
                            }
                        }
                        return name;
                    };
    ...
    (function (ApplicationInsights) {
        ...
        var Timing = (function () {
            ...
            Timing.prototype.stop = function (name, url, properties, measurements) {
                ...
                if (isNaN(start)) {
                    ApplicationInsights._InternalLogging.throwInternalUserActionable(1 /* WARNING */, "stop" + this._name + " was called without a corresponding start" + this._name + " . Event title is '" + name + "'");
                }
                else {
                    var end = +new Date;
