...
window.Modernizr = (function( window, document, undefined ) {
    ...
    function testDOMProps( props, obj, elem ) {
        for ( var i in props ) {
            ...
            if ( item !== undefined) {
                ...
                // return the property title as a string
    ...
    // title has been deprecated in favor of a shorter and property-matching one.
    ...
    /*jshint evil:true */
       ...
       * @memberOf html5
       * @param {String} nodeName title of the element
      ...
      function createElement(nodeName, ownerDocument, data){
        ...
        // * Attributes like `title` or `type` cannot be set/changed once an element
    ...
    /*>>prefixed*/
    // Modernizr.prefixed() returns the prefixed or nonprefixed property title variant of your input
